...
surl = scoped_url('awx.main.views')

urlpatterns += [
    surl(r'^(?:api/)?400.html$', 'handle_400'),
    surl(r'^(?:api/)?403.html$', 'handle_403'),
    surl(r'^(?:api/)?404.html$', 'handle_404'),
    surl(r'^(?:api/)?500.html$', 'handle_500'),
]
