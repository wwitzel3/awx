...
class TestInvalidOptionsFunctional:
    ...
    def test_invalid_inventory_id(self):
        ...
        with pytest.raises(CommandError) as err:
            cmd.handle_args(inventory_id=42, source='/notapath/shouldnotmatter')
    ...
    def test_invalid_inventory_name(self):
        cmd = inventory_import.Command()
        with pytest.raises(CommandError) as err:
            cmd.handle_args(inventory_name='fooservers', source='/notapath/shouldnotmatter')
...
class TestINIImports:
    ...
    def test_hostvars_are_saved(self, inventory):
        cmd = inventory_import.Command()
        cmd.handle_args(inventory_id=inventory.pk, source='doesnt matter')
